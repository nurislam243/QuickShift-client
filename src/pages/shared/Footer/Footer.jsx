...
const Footer = () => {
    return (
        <footer className="footer footer-horizontal rounded-4xl py-[80px] footer-center bg-neutral text-neutral-content px-10">
            <aside>
                <QuickShiftLogo textColor={"text-base-neutral"}></QuickShiftLogo>
                <p className="font-bold text-base-neutral/80 mt-4">
